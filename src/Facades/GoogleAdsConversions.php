 ...
 * @method static \ElectricTomCat\GoogleAdsConversions\Support\ClickIdentifier|null clickIdentifier()
 * @method static bool hasAttribution()
 * @method static array<int, string> cookieNames()
